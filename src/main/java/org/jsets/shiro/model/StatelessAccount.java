...
public class StatelessAccount implements Account{
	...
	public static StatelessAccount of(HmacToken hmacToken) {
		StatelessAccount account = new StatelessAccount();
		account.setTokenId(hmacToken.getDigest());
		account.setAppId(hmacToken.getAppId());
		account.setHost(hmacToken.getHost());
		account.setIssuedAt(new Date(Long.valueOf(hmacToken.getTimestamp())));
		return account;
	}
}